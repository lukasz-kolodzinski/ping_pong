...
#determine when players score
    if ball_x_axis <= 0:
        second_player_score += 1
        ball_x_axis = int(screen_width /2)
        ball_y_axis = int(screen_lengh /2)
    elif ball_x_axis >= screen_width:
...
#graphical content
    ...
    paddleA = pygame.draw.rect(screen_area,red,(paddleA_xaxis_position, paddleA_yaxis_position, paddleA_width, paddleA_heigh), 0)
    paddleB = pygame.draw.rect(screen_area,red,(paddleB_xaxis_position,paddleB_yaxis_position,paddleB_width, paddleB_heigh),0)
